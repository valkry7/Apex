...
echo -e " ${z}╰════════════════╯╰══════════════════╯╰════════════════════╯${NC}"
echo -e " ${z}╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " ${z}│$NC [${r}01${NC}]$purple MENU SSH/OVPN ${NC}     ${z}│$NC [${r}07${NC}]$purple Backup / Restore         ${NC} ${z}│  ${NC}"
echo -e " ${z}│$NC [${r}02${NC}]$purple MENU VMESS ${NC}   ${z}│$NC [${r}08${NC}]$purple Gotop x Ram              ${NC} ${z}│${NC}"    
echo -e " ${z}│$NC [${r}03${NC}]$purple MENU VLESS ${NC}   ${z}│$NC [${r}09${NC}]$purple Restart All Service      ${NC} ${z}│${NC}"   
echo -e " ${z}│$NC [${r}04${NC}]$purple MENU TROJAN ${NC}  ${z}│$NC [${r}10${NC}]$purple Tele Bot$NC              ${NC} ${z}│${NC}" 
