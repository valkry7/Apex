...
echo -e "          ${z}╰═══════════════════════════════════════════════╯${NC}"
echo -e " ${z}╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " ${z}│$NC ${G}01.)${NC} MENU SSH/OVPN ${NC}   ${r}07${NC} Backup / Restore         ${NC} ${z}│  ${NC}"
echo -e " ${z}│$NC ${G}02.)${NC} MENU VMESS ${NC}      ${r}08${NC} Gotop x Ram              ${NC} ${z}│${NC}"    
echo -e " ${z}│$NC ${G}03.)${NC} MENU VLESS ${NC}      ${r}09${NC} Restart All Service      ${NC} ${z}│${NC}"   
echo -e " ${z}│$NC ${G}04.)${NC} MENU TROJAN ${NC}     ${r}10${NC} Tele Bot                 ${NC} ${z}│${NC}" 
echo -e " ${z}│$NC ${G}05.)${NC} MENU SHADOW ${NC}     ${r}11${NC} Update Version.Sc        ${NC} ${z}│${NC}"
echo -e " ${z}│$NC ${G}06.)${NC} MENU TRIALL ${NC}     ${r}12${NC} Extra Menu                                ${NC} ${z}│${NC}"
echo -e " ${z}╰══════════════════════════════════════════════════════════╯${NC}"
