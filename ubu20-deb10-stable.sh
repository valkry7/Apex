...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Dev > Lunatic Tunneling ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}Lunatic Tunneling ® ${NC}${YELLOW}(${NC} ${green} LT ⭐ ${NC}${YELLOW})${NC}"
echo -e " © Recode By My Self LUNATIC TUNNELING ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/valkry7/Apex/ZX/"
...
wget -q https://raw.githubusercontent.com/valkry7/Apex/ZX/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
